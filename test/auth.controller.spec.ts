...
describe('AuthController (Integration)', () => {
  ...
  describe('POST /auth/forgot-password', () => {
    ...
    it('should enforce throttling on forgot-password requests', async () => {
      const forgotPasswordDto = {
        email: 'test@example.com',
      };
      ...
      // Note: The actual throttle limit is enforced by @Throttle decorator
      // in auth.controller.ts. This test verifies that the endpoint is decorated,
      // and the mock allows rapid testing without hitting actual throttle limits.
      // In integration tests with a real app, rate limiting behavior is verified
      // in backend.integration.spec.ts.
    });
  });
